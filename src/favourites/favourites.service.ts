...
export class FavouritesService {
    ...
    public async getUserFavourites(userId: string): Promise<CommonResponseModel> {
        let products = await this.favouritesModel.find({user: userId}).populate('product','title imageUrl filePath category isDealAvailable delaPercent variant averageRating')
